...
public class AddressDaoServiceStudent extends ReadingDatabase implements AddressDao {
    private Connection connection = getConnection();
    @Override
    public void add(Address address) throws SQLException {
        PreparedStatement preparedStatement = null;

        String sql = "INSERT INTO university.AddressStudent (addressId, city, street, house, flat) VALUES(?, ?, ?, ?, ?)";
    ...
    public List<Address> getAll() throws SQLException {
        ...
        String sql = "SELECT addressId, city, street, house, flat FROM university.AddressStudent";
    ...
    public Address getById(int id) throws SQLException {
        ...
        String sql = "SELECT addressId, city, street, house, flat FROM university.AddressStudent WHERE addressId=?";
    ...
    public void update(Address address) throws SQLException {
        ...
        String sql = "UPDATE university.AddressStudent SET city=?, street=?, house=?, flat=? WHERE addressId=?";
    ...
    public void remove(Address address) throws SQLException {
        ...
        String sql = "DELETE FROM university.AddressStudent WHERE addressId=?";
