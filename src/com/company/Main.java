...
public class Main {
    public static void main(String[] args) {
        ...
        StudentRepository studentRepository3 = new StudentRepository();
        ...
        studentRepository1.addStudent(student1);
        studentRepository1.addStudent(student2);
        studentRepository1.addStudent(student3);
        ...
        Group group1 = new Group(1, 3, studentRepository1.students, teacher1, 2007, 2012);
        ...
        Group group2 = new Group(2, 4, studentRepository2.students, teacher2, 2006, 2010);
        ...
        studentRepository3.addStudent(student7);
        studentRepository3.addStudent(student8);
        studentRepository3.addStudent(student9);
        ...
        teacherRepository.addTeacher(teacher3);
        teacherService.allTeachers(teacherRepository);
        Group group3 = new Group(3, 5, studentRepository2.students, teacher3, 2009, 2014);
        GroupRepository groupRepository = new GroupRepository();
        groupRepository.addGroup(group1);
        groupRepository.addGroup(group2);
        groupRepository.addGroup(group3);
        groupService.allGroup(groupRepository);
        teacherService.teachersRetired(teacherRepository);
        teacherService.salaries(teacherRepository);
        groupService.yearsGroup(groupRepository);
        teacherService.employees(teacherRepository);
        Methodist methodist1 = teacherService.comparator(teacher2, teacherRepository);
        System.out.println(methodist1);
        studentService.sortedStudents(studentRepository1);
        studentService.sortedStudents(studentRepository2);
        studentService.sortedStudents(studentRepository3);
    }
}